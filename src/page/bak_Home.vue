<template>
  <div id="home" class="container-fluid">
    <div class="desktop" v-if="this.mode=='desktop'">
      <header>
        <div class="left">
      ...
      <section>
        <div class="check-list row">
          <div class="col-md-12">
            ...
            <div class="check-item">
              ...
              <ul class="check list-inline">
                <li @click="selected(item, $event)" :class="{selected: item.isChecked}"
                    v-for="(item, index) in nationalityList" :key="index"><h6 v-text="item.text"></h6></li>
              </ul>
        ...
        <div class="card-list">
          ...
          <div>
            <div class="row">
              <div @click="showInfo(item, index)" class="card col-xs-6 col-md-3" :class="{first: index%4==0, four: index%4==3}" v-for="(item, index) in cardList" :key="index">
                <div>
                  <a class="thumbnail">
                  ...
                  <div class="desc">
                    ...
                    <div class="nationality">
                      ...
                      <i @click="attention(item)" class="fa fa-heart" :class="{attention: item.isAttention}" aria-hidden="true"><span v-text="item.attention"></span></i>
                    </div>
                  </div>
                </div>
              </div>
        ...
        <div class="info">
          <div class="banner">
            ...
            <div class="summary">
              ...
              <i @click="attention(showModel)" class="fa fa-heart" :class="{attention: showModel.isAttention}" aria-hidden="true"><span v-text="showModel.attention"></span></i>
            </div>
          </div>
